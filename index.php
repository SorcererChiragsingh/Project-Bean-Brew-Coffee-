...
<head>
    ...
    <title>Bean & Brew Coffee - Home</title>
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12 text-center">
                    ...
                    <h1 class="brand-name">Bean & Brew Coffee</h1>
